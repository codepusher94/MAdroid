...
if __name__ == "__main__":
    ...
    parser.add_argument("--deviceNum", nargs='+', help="device's number")
    ...
    task = args.task
    d_num = args.deviceNum
    dtype = []
    device_id = int(args.deviceid)
    history_action = args.historyAction
    history_screen = args.historyScreen
    history_activity = args.historyActivity
