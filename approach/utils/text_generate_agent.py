...
class Text_generate_agent:
    ...
    def input_generate(self, app_name: str, execute_info: dict, fixed_or_not: int, task: str):
        ...
        for e_component in no_hint_text:
            ...
            component_info['app_name'] = app_name
        ...
        iu = input_utils.INPUT_UI(app_name, activity, all_components, messages, fixed_or_not, task, self.llm)
