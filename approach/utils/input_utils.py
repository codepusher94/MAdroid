...
def use_context_info_generate_prompt(jsondata: dict):
    ...
    text_app_name = "This is an app called '<app name>'. "
...
class INPUT_UI:
    def __init__(self, app_name: str, activity_name: str, all_components: list, messages: list, is_fixed_text: int,
    ...
    def init_prompt(self):
        prompt = "Question: This is an app called \"{}\". On its \"{}\" page, it has {} input component. ".format(
            self.app_name,
            self.activity_name,
